      ...
      <div className="hotelContainer">
        {
          open && (
            <div className="slider">
             ...
             <div className="sliderWrapper">
              <img src={photos[sliderNo].src} alt="sliderImg"className="sliderImg" />
             </div>
          ...
          <button className="bookNow">Reserve or Book Now!</button>
            ...
            <span className="hotelDistance">Excellent Loaction - 500m from center</span>
